...
function seedDefaultEmailTemplates(store) {
  ...
  store.emailTemplates = [
    ...
    },
    {
      ...
      body: "Hi {{contactName}},\n\nJust following up on my previous note regarding {{painPointLabel}}.\n\nI'd love to share how we helped other {{industry}} businesses in {{region}} improve their workflow with {{productName}}.\n\nBest,\n{{senderName}}"
    },
    {
      id: "tmpl_default_3",
      name: "Intro",
